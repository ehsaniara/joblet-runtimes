#!/bin/bash
# Self-contained RHEL/CentOS ARM64 GraalVM JDK 21 Runtime Setup
...
install_dependencies() {
    ...
    # Install essential packages using yum/dnf
...
description: "GraalVM Community Edition JDK 21 Runtime (RHEL/CentOS ARM64)"
...
mounts:
  ...
  - source: "isolated/usr/sbin"
    target: "/usr/sbin"
    readonly: true
  # Essential libraries (RHEL uses lib64)
  - source: "isolated/lib"
    target: "/lib"
    readonly: true
...
main() {
    echo ""
    echo "🚀 Starting GraalVM JDK 21 Runtime Installation (RHEL/CentOS ARM64)"
    echo "=================================================================="
    ...
    echo ""
    echo "🎉 GraalVM JDK 21 Runtime Installation Complete! (RHEL/CentOS ARM64)"
    echo "===================================================================="
