#!/bin/bash
# Self-contained Amazon Linux AMD64 GraalVM JDK 21 Runtime Setup
...
description: "GraalVM Community Edition JDK 21 Runtime (Amazon Linux)"
...
main() {
    echo ""
    echo "🚀 Starting GraalVM JDK 21 Runtime Installation (Amazon Linux)"
    echo "=============================================================="
    ...
    echo ""
    echo "🎉 GraalVM JDK 21 Runtime Installation Complete! (Amazon Linux)"
    echo "==============================================================="
